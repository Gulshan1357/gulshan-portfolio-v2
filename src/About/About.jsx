  ...
  return (
    <section className="aboutMe" id="about">
      ...
      <p>
        ...
        platforms such as Virtual Reality and Mixed Reality headsets and mobile
        apps using Unity. Proficiency in Front‑End Web Development, with a
        Master’s degree in the field of Human‑Computer Interaction.
      </p>
      ...
      <article>
        ...
        <div className="expertise">
          <h5>XR Developer</h5>
          <p>
            I like to code 3D environments too. Creating immersive experience is
