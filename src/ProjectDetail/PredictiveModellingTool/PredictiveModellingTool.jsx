      ...
      <section className="container-full">
        <div className="container">
          ...
          <div className="content-offset">
            <p>
              In the scenario where a patient requires care beyond the hospital
              setting, they often transition to an Alternate Level of Care (ALC)
              destination such as Long-Term Care. This transition, however,
              presents several challenges. Patient experience is marked by
              uncertainty in the discharge process, coupled with extended
              waiting times. Our objective was to{" "}
          ...
          <div className="content-offset">
            ...
            <ul>
              <li className="large-li">
                ...
                professionals from SJHH (St. Joseph&apos;s Healthcare Hamilton),
                not solely to grasp the ALC process intricacies, but also to
                understand the distinct conditions guiding patients to specific
                ALC destinations. To ensure precision in our understanding and
                to ask pertinent questions, we translated the entire process
                into a MatLab Simulation Model incorporating logic gates.
              </li>
              <br />
              <li className="large-li">
                <span className="highlight">
              ...
              <br />
              <li className="large-li">
                <span className="highlight">Iterative Prototyping: </span> Along
                with stakeholder interviews, we initiated the creation and
                continuous refinement of prototypes to parallelly inform them
                our design process and get their feedback.
              </li>
              <br />
              <li className="large-li">
                <span className="highlight">Final Deliverables: </span>We
                presented the culmination of findings to our professors and
                Stakeholders from SJHH. This included an enhanced ALC discharge
                journey map alongside a Low-Fidelity wireframe for a Mobile App.
                This app is envisioned to provide patients with data on possible
                waiting times and discharge destinations within the ALC
                framework.
              </li>
            </ul>
          </div>
...
export default PredictiveModellingTool;
